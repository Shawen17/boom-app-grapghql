...
import { get_portfolio, update_portfolio } from "../../action/auth";
import { connect } from "react-redux";

const AccountUpdate = ({ get_portfolio, user, update_portfolio }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    body.append("_id", user.profile.email);
...
export default connect(mapStateToProps, { get_portfolio, update_portfolio })(
  AccountUpdate
);
