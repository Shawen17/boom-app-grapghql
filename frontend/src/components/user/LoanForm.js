...
const LoanForm = ({ user, update_portfolio, new_loan }) => {
  ...
  const accountKeys = ["accountBalance", "accountNumber", "bank", "bvn"];

  const loanKeys = ["currency", "loanRepayment", "duration", "bank", "amount"];
  ...
  const handleSubmit = async (event) => {
    ...
    const account = {
      ...
      accountNumber: inputs.accountNumber.toString(),
