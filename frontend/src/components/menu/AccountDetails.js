  ...
  <Details>
    ...
    <InfoWrapper>
      ...
      <PersonalInfo>
        ...
        <HeaderValue>{user.account ? user.account.bank : ""}</HeaderValue>
      </PersonalInfo>
      <PersonalInfo>
        <Header>Bvn</Header>
      ...
      <PersonalInfo>
        ...
        <HeaderValue>
          {user.account ? user.account.accountBalance : ""}
        </HeaderValue>
      </PersonalInfo>
      <PersonalInfo>
      ...
      <PersonalInfo>
        ...
        <HeaderValue>{`₦${user.account ? user.account.monthlyIncome[0] : ""}-₦${
          user.account ? user.account.monthlyIncome[1] : ""
        }`}</HeaderValue>
      </PersonalInfo>
    </InfoWrapper>
    <HorizontalLine />
