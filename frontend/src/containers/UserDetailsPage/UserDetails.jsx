...
const UserDetails = () => {
  ...
  const data = [
    ...
    { id: 4, title: "Loans", comp: <Loan user={user} /> },
          ...
          >
            ...
            <UserAction>
              ...
              <UserActionButton
                ...
                onClick={() => {
                  StatusUpdate(axios, "blacklist", user.profile.email);
                }}
                color="red"
              >
                BLACKLIST USER
              ...
              <UserActionButton
                onClick={() => {
                  StatusUpdate(axios, "activate", user.profile.email);
                }}
                color="aqua"
              >
                ACTIVATE USER
            ...
            <Info>
              <Wrapper>
                ...
                <div className="info">
                  ...
                  <p>{user.account ? user.account.accountName : ""}</p>
                </div>
                ...
                >
                  <p className="acc-bal-p">
                    ₦{user.account ? user.account.accountBalance : 0}
                  </p>
                  <div
                    style={{
                      fontSize: "12px",
