...
import { update_portfolio, new_loan } from "../../action/auth";

const UserDashboard = ({ user, update_portfolio, new_loan }) => {
  const data = [
    {
      id: 1,
...
export default connect(mapStateToProps, { update_portfolio, new_loan })(
  UserDashboard
);
